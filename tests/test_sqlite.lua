...
T["session"]["executes asynchronously without moving query focus"] = function()
    ...
    MiniTest.expect.equality(vim.wo[active.query_win].wrap, false)
    ...
    vim.api.nvim_set_current_win(active.result_win)
    MiniTest.expect.equality(vim.fn.maparg("<C-w>h", "n"), "")
    MiniTest.expect.equality(vim.fn.maparg("<C-w>k", "n"), "")
    press("<C-w>h")
    MiniTest.expect.equality(vim.api.nvim_get_current_win(), active.result_win)
    MiniTest.expect.equality(vim.api.nvim_get_current_tabpage(), scratchpad_tab)
    press("<C-w>k")
    MiniTest.expect.equality(vim.api.nvim_get_current_win(), active.query_win)
    MiniTest.expect.equality(vim.api.nvim_get_current_tabpage(), scratchpad_tab)
    press("<C-w>j")
